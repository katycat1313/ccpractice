      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto p-8">
          ...
          <div className="flex gap-4 mb-8">
            <button onClick={() => { setBuilderMode('create'); setScriptNodes([]); addNode(); }} className="bg-indigo-600 text-white font-semibold py-3 px-6 rounded hover:bg-indigo-700 flex items-center gap-2">
